...
Tractor.prototype.initDrag = function () {
  ...
  var isDrag2Valve = false; // 是否下拉到阈值，用来触发 hook 的标识
 ...
 */
Tractor.prototype.translateScroller = function (duration, dist) {
  var self = this;
  ...
  function translateRAF(timestamp) {
    ...
    var remain = self.translateValue - self.translateValue * (timestamp - time) / duration;
